...
const OrderTracker = () => {
  ...
  const OrderHandel = async (e) => {
    ...
    const res = await axios.get(
      `https://amazon-clone-nodejs-production.up.railway.app/api/order/order-tracker/${e.target.value}`
    );
  ...
  const socketOrder = async (oid) => {
    const res = await axios.get(
      `https://amazon-clone-nodejs-production.up.railway.app/api/order/order-tracker/${oid}`
    );
    // console.log(res.data)
    setOrderIdData(res.data);
  };
          ...
          <div className="container mt-5">
            <div className="row">
              <div className="col-12 mx-auto">
                <div className="card p-3">
                  <h5>
                    Order Id <span style={{ color: '#F7B030' }}>{orderId}</span>
                  </h5>
                  <h5>
                    Delivery Date:{' '}
                    <span style={{ color: '#F7B030' }}>
                      {new Date(
                        new Date(orderIdData.date).getTime() + 432000000
                      ).getDate()}
                      /
                      {new Date(
                        new Date(orderIdData.date).getTime() + 432000000
                  ...
                  <br />
                  <br />
                  {orderIdData.deliverystatus === 'order placed' && (
                    <div className="row">
                      <div className="col-lg-3 col-md-4 col-sm-6 col-12 mb-3">
                        <div className="card p-2 text-center">
                          <img
                            src="https://res.cloudinary.com/du9emrtpi/image/upload/v1632104225/9nnc9Et_u0nq7m.png"
                            alt=""
                            className="trackimg"
                          />
                          <p>
                      ...
                      <div className="col-lg-3 col-md-4 col-sm-6 col-12 mb-3">
                        <div className="card p-2 text-center">
                          <img
                            src="https://res.cloudinary.com/du9emrtpi/image/upload/v1632104246/u1AzR7w_nb1zxm.png"
                            alt=""
                            className="trackimg"
                          />
                          <p>
                      ...
                      <div className="col-lg-3 col-md-4 col-sm-6 col-12 mb-3">
                        <div className="card p-2 text-center">
                          <img
                            src="https://res.cloudinary.com/du9emrtpi/image/upload/v1632104235/TkPm63y_jkz3b0.png"
                            alt=""
                            className="trackimg"
                          />
                          <p>
                      ...
                      <div className="col-lg-3 col-md-4 col-sm-6 col-12 mb-3">
                        <div className="card p-2 text-center">
                          <img
                            src="https://res.cloudinary.com/du9emrtpi/image/upload/v1632104256/HdsziHP_rgr671.png"
                            alt=""
                            className="trackimg"
                          />
                          <p>
                  ...
                  {orderIdData.deliverystatus === 'order shipped' && (
                    <div className="row">
                      <div className="col-lg-3 col-md-4 col-sm-6 col-12 mb-3">
                        <div className="card p-2 text-center">
                          <img
                  ...
                  {orderIdData.deliverystatus === 'out for delivery' && (
                    <div className="row">
                      <div className="col-lg-3 col-md-4 col-sm-6 col-12 mb-3">
                        <div className="card p-2 text-center">
                          <img
                  ...
                  {orderIdData.deliverystatus === 'order delivered' && (
                    <div className="row">
                      <div className="col-lg-3 col-md-4 col-sm-6 col-12 mb-3">
                        <div className="card p-2 text-center">
                          <img
