...
const path = 'https://amazon-ecommerce.netlify.app/';
        ...
        <header className="">
          <div className="header_wraper">
            ...
            <div className="rightnav">
              <button className="btn btn-light pr-3" onClick={logout}>
                Logout
              </button>
              <div className="cartnav">
                <NavLink to="/cart">
                  <img
                    src={path + 'assets/shopping-cart.png'}
                    alt="cart"
                    className="cartimg"
                  />
            ...
            {cat?.map((val, ind) => {
              return (
                <>
                  <NavLink
                    key={ind}
                    to={'/category/' + val.category + '/' + val._id}
                    className="catnav"
                  >
                    {val.category}{' '}
                  </NavLink>
